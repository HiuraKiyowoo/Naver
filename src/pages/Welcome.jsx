...
const Welcome = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] font-nunito flex flex-col items-center justify-center px-6 text-white text-center">
      ...
      <div className="mb-8">
        <span className="text-[#F6CF80] font-black text-5xl tracking-tight">Naver</span>
        <span className="text-white font-black text-5xl tracking-tight">Novel</span>
      </div>
      <p className="text-white/50 text-sm font-medium mb-10 max-w-xs leading-relaxed">Baca Novel Online. Gratis.</p>
